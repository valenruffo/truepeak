      ...
      >
            ...
            return (
              <div key={item.href}>
                <Link href={item.href} onClick={() => setSidebarOpen(false)}
                  className={cn(
                    "flex items-center gap-2.5 text-[13px] font-medium px-3 py-2 rounded mb-0.5",
                    isActive ? "font-semibold" : "hover:bg-zinc-700/50"
                  )}
                    ...
                    {item.children.map((child) => {
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            "block text-[12px] font-medium px-3 py-1.5 rounded",
                            isChildActive ? "font-semibold" : "hover:bg-zinc-700/50"
                          )}
                          style={{ 
        ...
        <div className="px-4 mb-3 mt-2 pt-3 border-t" style={{ borderColor: "var(--border)" }}>
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 rounded text-[12px] font-medium hover:bg-zinc-700/50"
        ...
        <div className="mt-auto px-3 pb-4 pt-3 border-t" style={{ borderColor: "var(--border)" }}>
          ...
          <div className="space-y-0.5">
            <Link
              href="/settings"
              onClick={() => setSidebarOpen(false)}
              className="flex items-center gap-2.5 text-[13px] px-3.5 py-1.5 rounded hover:bg-zinc-700/50"
              style={{ color: "var(--text-muted)" }}
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 text-left text-[13px] px-3.5 py-1.5 rounded hover:bg-zinc-700/50"
              style={{ color: "var(--text-muted)" }}
            >
