                ...
                if (isFree) {
                  return (
                    <div className="max-w-6xl mx-auto px-6 py-8 relative">
                      <div className="rounded border p-8" style={{ borderColor: "var(--border)", background: "var(--bg-secondary)", filter: "blur(6px)", pointerEvents: "none", userSelect: "none" }}>
                        <h1 className="font-display font-semibold text-xl mb-6">{t("crm.title")}</h1>
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
                        <div className="text-center p-8 rounded border" style={{ background: "var(--bg-secondary)", borderColor: "var(--border)" }}>
                          ...
                          <a href="https://truepeak.lemonsqueezy.com/checkout/buy/xxx" target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-2.5 text-sm font-medium rounded transition-all hover:opacity-90 cursor-pointer" style={{ background: "#10b981", color: "#09090b" }}>
                            {t("crm.locked.cta")}
                          </a>
                        </div>
                      </div>
